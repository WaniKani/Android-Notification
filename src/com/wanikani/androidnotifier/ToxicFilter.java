 ...
 */
public class ToxicFilter implements Filter {
	...
	private class Task extends AsyncTask<Void, ItemLibrary<Item>, Boolean > {
		...
		public void reissue ()
		{
			/* No need to do anything, we are not incremental */
		}
	}
	 ...
	 */
	public ToxicFilter (Filter.Callback itemf)	
	{
		this.itemf = itemf;
	}
